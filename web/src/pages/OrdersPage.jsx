...
function OrdersPage() {
    ...
    function getProduct(id) {
        if (getProductFromID(productsArray,id) === -1) {
           return new Product(123,"product deleted from db",100,"deleted","deleted","deleted",1,[]);
        }
        return getProductFromID(productsArray,id);
    }
