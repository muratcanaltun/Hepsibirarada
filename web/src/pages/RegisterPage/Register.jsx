...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try{
            const response = await axios.post(REGISTER_URL, JSON.stringify({username: user, email, password }),
            {
        ...
        <section>
            ...
            <form className="login-form" onSubmit={handleSubmit}>
               ...
               {!validPassword && passwordFocus ? <p
                ...
                ></input>
                {!validMatchPassword && matchPasswordFocus ?<p
                    id="confirmnote"
                    className={
                ...
                <label>
                    <input type="radio" className ="userType" value="store" name="userType" />
                    Store Owner
                </label>
                <label>
                    <input type="radio" className ="userType" value="customer" name="userType" />
                    Customer
                </label>
                <button
                    disabled={
